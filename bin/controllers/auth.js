...
exports.signup = async (req, res) => {
    try {
        ...
        if (!req.body.number || !req.body.password || !req.body.fullName || req.body.number.length != 10) throw customError.dataInvalid;
...
exports.login = async (req, res) => {
    try {
        ...
        if (!req.body.number || !req.body.password || req.body.number.length != 10) throw customError.dataInvalid;
